package com.example.number_puzzle_2;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void win() {
        if (b1.equals("1") && b2.equals("2") && b3.equals("3") && b4.equals("4") && b5.equals("5")
                && b6.equals("6") && b7.equals("7") && b8.equals("8") && b9.equals("")) {
            Toast.makeText(this, "puzzle is solve", Toast.LENGTH_SHORT).show();
        } else {
    ...
    private void reset() {
        list.clear();
        count = 0;
        Toast.makeText(this, "function is colled ", Toast.LENGTH_SHORT).show();
